...
type UpdateConnectorNodeRequest struct {
...
func NewUpdateConnectorNodeRequest() *UpdateConnectorNodeRequest {
	this := UpdateConnectorNodeRequest{}
	return &this
}
...
func (o UpdateConnectorNodeRequest) MarshalJSON() ([]byte, error) {
...
type NullableUpdateConnectorNodeRequest struct {
	value *UpdateConnectorNodeRequest
	isSet bool
}

func (v NullableUpdateConnectorNodeRequest) Get() *UpdateConnectorNodeRequest {
	return v.value
}

func (v *NullableUpdateConnectorNodeRequest) Set(val *UpdateConnectorNodeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateConnectorNodeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateConnectorNodeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateConnectorNodeRequest(val *UpdateConnectorNodeRequest) *NullableUpdateConnectorNodeRequest {
	return &NullableUpdateConnectorNodeRequest{value: val, isSet: true}
}

func (v NullableUpdateConnectorNodeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateConnectorNodeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
