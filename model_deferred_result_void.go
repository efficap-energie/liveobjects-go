...
func (o DeferredResultVoid) MarshalJSON() ([]byte, error) {
...
type NullableDeferredResultVoid struct {
	value *DeferredResultVoid
	isSet bool
}

func (v NullableDeferredResultVoid) Get() *DeferredResultVoid {
	return v.value
}

func (v *NullableDeferredResultVoid) Set(val *DeferredResultVoid) {
	v.value = val
	v.isSet = true
}

func (v NullableDeferredResultVoid) IsSet() bool {
	return v.isSet
}

func (v *NullableDeferredResultVoid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeferredResultVoid(val *DeferredResultVoid) *NullableDeferredResultVoid {
	return &NullableDeferredResultVoid{value: val, isSet: true}
}

func (v NullableDeferredResultVoid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeferredResultVoid) UnmarshalJSON(src []byte) error {
	v.isSet = true
