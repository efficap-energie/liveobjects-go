...
type ContextContainerList struct {
	...
	Data []ContextContainer `json:"data"`
}
...
func (o ContextContainerList) MarshalJSON() ([]byte, error) {
...
type NullableContextContainerList struct {
	value *ContextContainerList
	isSet bool
}

func (v NullableContextContainerList) Get() *ContextContainerList {
	return v.value
}

func (v *NullableContextContainerList) Set(val *ContextContainerList) {
	v.value = val
	v.isSet = true
}

func (v NullableContextContainerList) IsSet() bool {
	return v.isSet
}

func (v *NullableContextContainerList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContextContainerList(val *ContextContainerList) *NullableContextContainerList {
	return &NullableContextContainerList{value: val, isSet: true}
}

func (v NullableContextContainerList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContextContainerList) UnmarshalJSON(src []byte) error {
	v.isSet = true
